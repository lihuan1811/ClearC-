...
private:
    ...
    void setCleanupSelection(bool checked);
    void restoreDefaultCleanupSelection();
    void resetCleanupCatalog();
    void updateCleanupDetails(QTreeWidgetItem* item);
    void updateCleanupSelectionSummary();
    QSet<QString> selectedCleanupRuleIds() const;
    ...
    QLabel* cleanupSelectionLabel_ = nullptr;
    QLabel* cleanupDescriptionTitle_ = nullptr;
    QLabel* cleanupDescriptionMeta_ = nullptr;
    QLabel* cleanupDescriptionText_ = nullptr;
    QLabel* cleanupDescriptionPaths_ = nullptr;
    QProgressBar* scanProgress_ = nullptr;
    QTreeWidget* cleanupTree_ = nullptr;
    QPushButton* cleanupScanButton_ = nullptr;
    QPushButton* cleanupCleanButton_ = nullptr;
    QVector<CleanupEntry> cleanupEntries_;
    QSet<QString> lastScannedCleanupRuleIds_;
    bool cleanupScanCompleted_ = false;
    bool cleanupScanInProgress_ = false;
    QString backupRoot_;
